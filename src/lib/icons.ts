// 인라인 SVG 아이콘 셋 (Lucide ISC 기반, 24×24 / stroke 2 / round). 오프라인·무의존,
// currentColor 상속으로 라이트/다크·활성색 자동. UI 크롬 이모지를 이걸로 전면 교체.
// 콘텐츠성 이모지(무드/스티커/쿡찌르기 종류/사용자 지정)는 그대로 둔다.
