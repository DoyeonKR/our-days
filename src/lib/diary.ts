...
// '작년 오늘'(onThisDay·yearsAgo)과 기분 집계(moodCounts)는 2026-09-24 에 뺐다 — 일기장 안의 두 블록이
// 기록 › 추억 칸으로 합쳐지면서 lib/memories(onThisDayMemories · monthlyRecap.moods)가 같은 일을 한다.
